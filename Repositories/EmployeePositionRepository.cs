...
namespace EmployeeManagment.Repositories
{
    public class EmployeePositionRepository
    {
        ...
        {
            return await  _context.EmployeePositions.Where(x => x.Id == id).FirstOrDefaultAsync();
        }
        ...
        {
            return await _context.EmployeePositions.Where(x => x.EmployeeId == employeeId).ToListAsync();
        }
